...
#     assert_equal(G.node[1][c][0], 46.25)
#     assert_equal(len(G.node[2]), 1)
#     assert_equal(G.node[2][c][0], 20)
#     assert_equal(len(G.node[3]), 1)
#     assert_equal(G.node[3][c][0], 97.5)
#     assert_equal(len(G.node[4]), 1)
#     assert_equal(G.node[4][c][0], 140)

#     w = 'weight'
#     assert_equal(len(G[1][2]), 1)
#     assert_equal(G[1][2][w], 0.703125)
#     assert_equal(len(G[1][3]), 1)
#     assert_equal(G[1][3][w], 3.015625)
#     assert_equal(len(G[1][4]), 1)
#     assert_equal(G[1][4][w], 5.203125)
#     assert_equal(len(G[3][4]), 1)
#     assert_equal(G[3][4][w], 2.125)
